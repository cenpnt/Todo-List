        ...
        return (
          <div key={link.name}>
            <Link
              href={link.path}
              className={clsx(
                "flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-transparent p-3 text-sm text-black font-medium hover:bg- hover:text-slate-200 md:flex-none md:justify-start md:p-2 md:px-3",
                  {
